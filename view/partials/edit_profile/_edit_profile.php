            ...
            <div class="section">
                ...
                <div class="section-content">
                    <div class="form-group">
                        ...
                        <p class="form-help">We'll use this email to send you notifications about your sales and
                            purchases</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="iban" class="form-input"
                            value="<?= htmlspecialchars($user['iban'] ?? '') ?>" placeholder="BE99 9999 9999 9999 9999">
                        <p class="form-help">For receiving payments from your sales. Leave empty if you don't want to
                            receive payments directly.</p>
                    </div>
                </div>
            </div>
        </form>